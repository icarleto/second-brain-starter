...
The physical house, finances, admin, insurance, vehicles. Anything with a bill or a renewal date attached.
...
WHERE !completed AND contains(lower(text), "#home")
SORT file.name DESC
```
